...
const ProductCard = ({ product }: Props) => {
  ...
  return (
    <div>
      <div className="max-w-sm bg-white border border-gray-200 shadow dark:bg-gray-950 dark:border-gray-800 rounded-lg">
        ...
        <div className="p-5 ">
          ...
          <Link
            ...
            className="rounded-lg inline-flex items-center mx-3
