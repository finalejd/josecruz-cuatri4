...
import imagenquince from "../assets/Gifs y Pixel Art/15.png";
import imagendieciseis from "../assets/Gifs y Pixel Art/16.png";
import imagendiecisiete from "../assets/Gifs y Pixel Art/17.jpeg";
